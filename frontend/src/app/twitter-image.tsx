...
export default function Image() {
    return new ImageResponse(
        (
            ...
            >
                <div style={{ position: 'absolute', bottom: -200, left: -200, width: 800, height: 800, background: '#4f46e5', filter: 'blur(200px)', opacity: 0.25, borderRadius: '50%' }} />
