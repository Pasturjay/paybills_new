...
class ClubKonnectProvider {
    ...
    async purchaseAirtime(networkId, phoneNumber, amount, requestId) {
        try {
    ...
    async purchaseData(networkId, planId, phoneNumber, requestId) {
        try {
    ...
    async validateCableSmartcard(providerId, smartcardNumber) {
        try {
    ...
    async purchaseCable(providerId, packageId, smartcardNumber, requestId) {
        try {
    ...
    async validateElectricityMeter(providerId, meterNumber, type) {
        try {
    ...
    async purchaseElectricity(providerId, meterNumber, amount, requestId) {
        try {
    ...
    async fundBettingWallet(customerId, amount, providerCode, requestId) {
        try {
    ...
    async purchaseEducationPIN(type, quantity, requestId) {
        try {
    ...
    async printRechargeCard(networkId, amount, quantity, requestId) {
        try {
