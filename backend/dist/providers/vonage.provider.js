...
class VonageProvider {
    ...
    searchNumbers(countryCode) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.get(`${this.config.baseUrl}/number/search`, {
                    params: {
    ...
    // 2. Rent Number
    rentNumber(countryCode, msisdn) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                const response = yield axios_1.default.post(`${this.config.baseUrl}/number/buy`, new URLSearchParams({
                    api_key: this.config.apiKey,
                    api_secret: this.config.apiSecret,
                    country: countryCode,
                    msisdn: msisdn
    ...
    // 3. Cancel Number
    cancelNumber(countryCode, msisdn) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post(`${this.config.baseUrl}/number/cancel`, new URLSearchParams({
                    api_key: this.config.apiKey,
                    api_secret: this.config.apiSecret,
                    country: countryCode,
                    msisdn: msisdn
