...
function testKYCFlow() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                const initiateResponse = yield axios_1.default.post(`${API_URL}/api/kyc/initiate`, {}, {
                    headers: {
            ...
            const webhookResponse = yield axios_1.default.post(`${API_URL}/api/kyc/webhook`, webhookPayload);
            console.log('Webhook Status:', webhookResponse.status);
            // Verify DB update
            const updatedUser = yield prisma.user.findUnique({ where: { id: testUser.id } });
            ...
            if (testUser) {
                console.log('\n--- Cleaning up ---');
                yield prisma.user.delete({ where: { id: testUser.id } });
            }
