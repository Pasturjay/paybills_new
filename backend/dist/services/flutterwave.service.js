...
class FlutterwaveService {
    ...
    async createVirtualAccount(email, bvn, txRef, firstName, lastName, phoneNumber) {
        var _a, _b, _c;
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/virtual-account-numbers`, {
                email,
                is_permanent: true,
                bvn,
                tx_ref: txRef,
